...
const VIRUSES = {
  ...
  STATIC: {
    ...
    errors: [
      ...
      { template: TPL.AV,    title: "Antenna Calibration", message: "TV antenna signal lost on display port 2. Running channel_sync.scr to restore signal from broadcast tower. Estimated time: 3 minutes.", meta: "Process: channel_sync.scr · Source: antennasync{tld} · Signed: No" },
  ...
  CRYPTEX: {
    ...
    errors: [
      ...
      { template: TPL.WIN11, title: "OneDrive Vault Locked", message: "Your Personal Vault has been encrypted by a security service. Pay 0.5 BTC at onedrive-restore{tld} to restore access.", meta: "Files: 18,442  |  Wallet: bc1qxy2kg…  |  Timer: 23:00:00", borderPulse: true },
