...
const VIRUSES = {
  ...
  CRYPTEX: {
    ...
    errors: [
      ...
      { template: TPL.TOAST, title: "Vault Backup", message: "Backup complete! Your files have a new .vault extension. Premium key ($299) required to restore access.", meta: "Files: {numfiles} · Wallet: {wallet} · Timer: {timer}" },
